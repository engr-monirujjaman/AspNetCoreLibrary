...
namespace Microsoft.AspNetCore.Diagnostics.EntityFrameworkCore.CodeGenerator
{
    [Generator]
    public class EntityFrameworkCoreExtensionsSourceGenerator : ISourceGenerator
    {
        public void Execute(SourceGeneratorContext context)
        {
            ...
            var className = "HttpContextDatabaseContextDetailsExtensions";
...
{{
    ...
    {{
        public static async Task<DatabaseContextDetails> GetContextDetailsAsync(HttpContext httpContext, Type dbcontextType, ILogger logger)
        {{
            // TODO: Decouple
